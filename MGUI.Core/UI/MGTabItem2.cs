...
namespace MGUI.Core.UI
{
    ...
    public class MGTabItem2 : MGSingleContentHost
    {
        public MGTabControl2 TabControl { get; }
        ...
        internal MGTabItem2(MGTabControl2 TabControl, MGElement Header, MGElement TabContent)
